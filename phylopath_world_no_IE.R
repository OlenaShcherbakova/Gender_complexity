...
write.csv(table_final, file="output_tables/Phylopath_output_table_W_no_IE.csv")
...
save_as_docx(
  "Phylogenetic path analysis (World without Indo-European languages)" = table_final, 
  path = "output_tables/Phylopath_output_table_W_no_IE.docx")
...
save(a_ci, 
     file = "output/phylopath_w_no_IE.RData")
load('output/phylopath_w_no_IE.RData')
