...
results.dep.world <- 
  list.files(path = "./results_bayestraits_minitest/", pattern = "\\.dependent.log.Log.txt", 
             full.names = TRUE, recursive = TRUE)

results.indep.world <- 
  list.files(path = "./results_bayestraits_minitest/", pattern = "\\.independent.log.Log.txt", 
             full.names = TRUE, recursive = TRUE)
